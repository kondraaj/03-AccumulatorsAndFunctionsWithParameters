...
def run_test_sum_of_digits():
    ...
    # My 2nd test
    expected = 9
    actual = sum_of_digits(234)
    print('My 2nd test expected:', expected)
    print('       actual:       ', actual)
    # My 3rd test
    expected = 10
    actual = sum_of_digits(190)
    print('My 3rd test expected:', expected)
    print('       actual:       ', actual)
    # My 4th test
    expected = 9
    actual = sum_of_digits(1215)
    print('My 4th test expected:', expected)
    print('       actual:       ', actual)
...
def run_test_digits_in_cube():
    ...
    # Test 1
    expected = 9
    actual = digits_in_cube(3)
    print('My 1st test expected:', expected)
    print('     acutal:         ', actual)
    # Test 2
    expected = 10
...
def run_test_digits_in_power():
    ...
    # Test 1
    expected = 7
    actual = digits_in_power(2, 4)
    print('Test 1 expected:', expected)
    print('    actual:     ', actual)
    # Test 2
    expected = 10
    actual = digits_in_power(7, 3)
    print('Test 2 expected', expected)
    print('    actual:    ', actual)
    # Test 3
    expected = 4
    actual = digits_in_power(11, 2)
